...
export default function TermsAndConditions() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Terms & Conditions | Dahab Miners Electrical Contracting LLC
        </title>
        <meta
          name="description"
          content="Read the official terms and conditions of Dahab Miners Electrical Contracting LLC, covering mining hardware sales, hosting, repairs, payments, and UAE governing law."
        />
        <meta
          name="keywords"
          content="Dahab Miners terms and conditions, crypto mining terms UAE, ASIC miner hosting terms, mining service agreement UAE, Dahab Miners legal policy"
        />
        <link
          rel="canonical"
          href={fullUrl || "https://dahabminers.com/terms_and_conditions"}
        />
      </Helmet>
