...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Dahab Miners Electrical Contracting LLC</title>
        <meta
          name="description"
          content="Learn how Dahab Miners collects, uses, and protects personal data related to mining hardware sales, hosting services, repairs, and payments in the UAE."
        />
        <meta
          name="keywords"
          content="Dahab Miners privacy policy, crypto mining privacy UAE, ASIC mining data protection, mining hosting privacy policy, UAE data protection mining"
        />
        <link
          rel="canonical"
          href={fullUrl || "https://dahabminers.com/privacy_policy"}
        />
      </Helmet>
